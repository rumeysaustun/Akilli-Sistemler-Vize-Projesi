...
pencere_acikligi['kapali'] = fuzz.trimf(pencere_acikligi.universe, [0, 0, 50])
pencere_acikligi['yarim_acik'] = fuzz.trimf(pencere_acikligi.universe, [0, 50, 100])
pencere_acikligi['acik'] = fuzz.trimf(pencere_acikligi.universe, [50, 100, 100])
...
kural3 = ctrl.Rule(sicaklik['soğuk'] & nem['nemli'], pencere_acikligi['acik'])

kural4 = ctrl.Rule(sicaklik['ilik'] & nem['kuru'], pencere_acikligi['yarim_acik'])
kural5 = ctrl.Rule(sicaklik['ilik'] & nem['normal'], pencere_acikligi['yarim_acik'])
kural6 = ctrl.Rule(sicaklik['ilik'] & nem['nemli'], pencere_acikligi['acik'])
...
kural9 = ctrl.Rule(sicaklik['sicak'] & nem['nemli'], pencere_acikligi['yarim_acik'])
